    ...
    <section>
      <div className={`sidebar ${open ? 'active' : 'inactive'}`}>
        <div className='shortcut-links'>
          <p className='a'><img src={Home} /><p>Home</p></p>
          <p className='a'><img src={Explore} /><p>Explore</p></p>
          <p className='a'><img src={Subscritions} /><p>Subscriptions</p></p>
          <p className='a'><img src={Library} /><p>Library</p></p>
          <p className='a'><img src={History} /><p>History</p></p>
          <p className='a'><img src={Playlist} /><p>Playlist</p></p>
          <p className='a'><img src={Messages} /><p>Messages</p></p>
          <p className='a'><img src={Showmore} /><p>Show more</p></p>
          <hr />
        </div>
...
function Video({ thumbnail, channelImage, title, channelName, views, uploadTime, link } ){
  ...
  return (
    <div className='vid-list'>
      ...
      <Link to={link}>
        <a href={link}><img src={thumbnail} className='thumbnail' alt='Video Thumbnail' /></a>
      </Link>
      <div className='flex-div'>
        <img src={channelImage} alt='Channel Image' />
        <div className='vid-info'>
          <Link to={link}><a href={link}>{title}</a></Link>
          <p>{channelName}</p>
